...
public class SwiftyMenu: UIView {
    ...
    @IBInspectable public var menuHeaderBackgroundColor: UIColor = .clear {
        didSet {
    ...
    @IBInspectable public var optionColor: UIColor = .white
...
extension SwiftyMenu {
    ...
    public func didSelectOption(completion: @escaping (_ selected: String, _ index: Int) -> ()) {
